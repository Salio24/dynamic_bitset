...
namespace sul
{
    ...
    public:
         ...
         * @return The position of the last bit set in the sequence, or npos if the bit at @p pos is 0, or @p pos is out of bounds.
         */
        [[nodiscard]] constexpr size_type find_sequence_end(size_type pos) const;
